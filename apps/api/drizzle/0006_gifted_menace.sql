CREATE TYPE "public"."permission_scope" AS ENUM('self', 'direct_reports', 'reporting_tree', 'team', 'department', 'project', 'organization');--> statement-breakpoint
CREATE TABLE "roles" (
...
CREATE UNIQUE INDEX "role_permissions_unique" ON "role_permissions" USING btree ("role_id","permission_id","scope");--> statement-breakpoint
